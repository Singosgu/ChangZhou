...
export default {
  ...
  upload_center: {
    ...
    uploadfiles: 'Upload',
    upload: 'Upload',
    initalinventory: 'Inital inventory',
    addbinsize: 'Add storage location',
  ...
  twoKai: {
    duocang: "Change Warehouse",
    useWarehouse: "Current warehouse",
    handcount: "Single item inventory",
    handcountrecorder: "Individual inventory records",
    locationscount: "Inventory of inventory locations",
    locationscountrecorder: "Inventory records of storage locations",
    downloadjianhuodantip: "Download all picking lists",
    confirmationinprogress: "Shipping generation in progress",
    confirmingshipment: "Picking generation in progress",
    confirming: "Confirming",
    download_tags: "Download tags",
    patch_number: "Batch number",
    warehouse_id: "warehouse",
    update_time: "Inventory time",
    deliver_download: "Download Shipping Order",
    look_jianhuodan: "View picking list",
    view_batch: {
      batch_name: "Batch number",
      error1: "Please enter the batch number",
    },
    view_warehouse: {
      warehouse_name: "warehouse",
      error1: "Please select a warehouse",
    },
    upload_asn: {
      title: "Upload files",

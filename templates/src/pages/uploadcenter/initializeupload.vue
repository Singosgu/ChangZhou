<template>
  <div
    class="shadow-24 q-pa-md"
    :style="{ height: height, background: 'white', borderRadius: '4px' }"
  >
    <q-btn-group push>
      <q-btn
        :label="$t('upload_center.downloadgoodstemplate')"
        icon="cloud_download"
        @click="downloadgoodstemplate()"
      >
        <q-tooltip
          content-class="bg-amber text-black shadow-4"
          :offset="[10, 10]"
          content-style="font-size: 12px"
          >{{ $t("upload_center.downloadgoodstemplate") }}</q-tooltip
        >
      </q-btn>
      <q-btn
        :label="$t('upload_center.downloadcustomertemplate')"
        icon="cloud_download"
      ...
      >
        <q-tooltip
          ...
          :offset="[10, 10]"
          content-style="font-size: 12px"
          >{{ $t("upload_center.downloadcustomertemplate") }}</q-tooltip
        >
      </q-btn>
      <q-btn
        :label="$t('upload_center.downloadsuppliertemplate')"
        icon="cloud_download"
      ...
      >
        <q-tooltip
          ...
          :offset="[10, 10]"
          content-style="font-size: 12px"
          >{{ $t("upload_center.downloadsuppliertemplate") }}</q-tooltip
        >
      </q-btn>
    </q-btn-group>

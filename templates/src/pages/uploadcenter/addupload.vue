  ...
  <div class="shadow-24 q-pa-md" :style="{ height: height, background: 'white',borderRadius: '4px' }">
    ...
    <div style="display: flex;">
      ...
      <div class="q-pt-md q-gutter-md row items-start">
        <q-uploader
          style="width:300px;height:200px"
          :url="init_stock_pathname"
          method="post"
          :headers="[{ name: 'token', value: token }, { name: 'language', value: lang }, { name: 'operator', value: login_id }]"
          :field-name="file => 'file'"
          :label="$t('upload_center.initalinventory')"
          accept=".xlsx,csv,xls/*"
          @rejected="onRejected"
          @added="getfileinfo"
        />
        ...
        <q-uploader
          ...
          :headers="[{ name: 'token', value: token }, { name: 'language', value: lang }, { name: 'operator', value: login_id }]"
          :field-name="file => 'file'"
          :label="$t('upload_center.addbinsize')"
          accept=".xlsx,csv,xls/*"
          @rejected="onRejected"
          @added="getfileinfo"
        />
...
export default {
  ...
  data() {
    return {
      ...
      init_stock_pathname: baseurl + 'uploadfile/stockfile/',
      bin_pathname: baseurl + 'uploadfile/binfile/'
    };
  },
  methods: {
    checkFileType(files) {

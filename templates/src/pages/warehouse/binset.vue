        ...
        <q-card-section>
          <div class="row" style="height: 50px">
            ...
            >
              <p style="font-size: 20px; font-weight: 550">
                {{ $t("warehouse.view_binset.bin_name") + ":" + bin_name }}
              </p>
            </div>
          </div>
          <hr />
          <div class="row">
            <div class="col-8" style="margin-top: 30px; padding-left: 3%">
              <p style="font-size: 20px; font-weight: 550">
                {{ $t("warehouse.view_binset.bin_property") + ":" }}
              </p>
              <p style="font-size: 20px; font-weight: 550">
                {{ bin_property }}
              </p>
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {
          name: "bin_size",
          label: this.$t("warehouse.view_binset.bin_size"),
          field: "bin_size",
          align: "center",
        },
        {
          name: "bin_property",
          label: this.$t("warehouse.view_binset.bin_property"),
          field: "bin_property",
          align: "center",
        },
        {
  ...
  methods: {
    ...
    newDataSubmit() {
      ...
      if (
        binsets.indexOf(_this.newFormData.bin_name) === -1 &&
        _this.newFormData.bin_name.length !== 0
      ) {
    ...
    downloadData() {
      ...
      if (LocalStorage.has("auth")) {
        getfile(
          _this.pathname + "file/?lang=" + LocalStorage.getItem("lang")
        ).then((res) => {

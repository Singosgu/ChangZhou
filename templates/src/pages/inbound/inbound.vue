          ...
          <q-tabs v-model="detaillink">
            ...
            <!--  <transition appear enter-active-class="animated zoomIn">
              <q-route-tab
                ...
                :label="$t('inbound.predeliverystock')"
                icon="img:statics/inbound/polist.png"
                :to="{ name: 'predeliverystock' }"
                exact
              />
            </transition>
            <transition appear enter-active-class="animated zoomIn">
              <q-route-tab
                name="preloadstock"
                :label="$t('inbound.preloadstock')"
                icon="img:statics/inbound/preloadstock.png"
                :to="{ name: 'preloadstock' }"
                exact
              />
            </transition>
            <transition appear enter-active-class="animated zoomIn">
              <q-route-tab
                name="presortstock"
                :label="$t('inbound.presortstock')"
                icon="img:statics/inbound/presortstock.png"
                :to="{ name: 'presortstock' }"
                exact
              />
            </transition> -->
            <transition appear enter-active-class="animated zoomIn">
            ...
            <!-- <transition appear enter-active-class="animated zoomIn">
              <q-route-tab
                name="shortage"
                :label="$t('inbound.shortage')"
                icon="img:statics/inbound/shortage.png"
                :to="{ name: 'shortage' }"
                exact
              />
            </transition>
            ...
            <transition appear enter-active-class="animated zoomIn">
              <q-route-tab
                ...
                icon="img:statics/inbound/asnfinish.png"
                :to="{ name: 'asnfinish' }"
                exact
              />
            </transition>

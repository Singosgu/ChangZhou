...
urlpatterns = [
    ...
    path(r'fixasn/<str:openid>/<str:asn_code>/<int:status>/', views.fixasn, name='fixasn'),
    path(r'changeasn/', views.changeasn, name='changeasn'),
    path(r'changedn/<str:oldvalue>/<str:newvalue>/', views.changedn, name='changedn'),
    path(r'initw99/', views.initW99, name='initW99'),
    path(r'changepwd/<str:user>/<str:pwd>/', views.changepwd, name='changepwd'),
    path(r'getip/', views.get_inner_ip, name='get_inner_ip'),

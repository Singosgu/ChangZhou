...
def cn_data_header():
    return dict([
        ...
        ('goods_weight', u'商品重量(单位:g)'),
        ('goods_w', u'商品长度(单位:mm)'),
        ('goods_d', u'商品宽度(单位:mm)'),
        ('goods_h', u'商品高度(单位:mm)'),
...
def en_data_header():
    return dict([
        ...
        ('goods_weight', u'Goods Weight (unit:g)'),
        ('goods_w', u'Goods Wide (unit:mm)'),
        ('goods_d', u'Goods Depth (unit:mm)'),
        ('goods_h', u'Goods Height (unit:mm)'),

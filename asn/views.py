            ...
            for j in range(len(data['goodsData'])):
                ...
                if int(data['goodsData'][j].get('goods_actual_qty')) == 0:
                    ...
                    if goods_qty_check > 0:
                        ...
                        goods_qty_change.pre_sort_stock = goods_qty_change.pre_sort_stock - asn_detail.goods_qty
                    goods_qty_change.onhand_stock = goods_qty_change.onhand_stock + int(data['goodsData'][j].get('goods_actual_qty'))
                    ...
                    if bin_check.exists():
                        ...
                        bin_stock = 0
                    if line_data.exists():
                        line_data.goods_qty = bin_stock + int(data['goodsData'][j].get('goods_actual_qty'))
                    ...
                    stockbin.objects.create(openid=self.request.auth.openid,
                                            ...
                                            bin_level=10,
                                            t_code=Md5.md5(str(data['goodsData'][j].get('goods_code'))),
                                            create_time=asn_detail.create_time)
                ...
                if 'bin_name' not in data:
                    ...
                    if int(data['qty']) <= 0:
                        ...
                        if move_qty > 0:
                            ...
                            try:
                                bin_level = int(bin_detail.bin_name.split('-')[2]) + 1
                            except:
                                bin_level = 1

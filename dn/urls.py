...
path(r'pickinglistget/', views.DnPickingListQueryFilterViewSet.as_view({"get": "list"}), name="DnPickingListQueryFilterViewSet"),
...
re_path(r'^comments/(?P<pk>\d+)/$', views.DnCommentsViewSet.as_view({
    'post': 'create',
}), name="comments_1"),
